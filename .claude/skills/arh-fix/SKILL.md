---
name: arh-fix
description: Hotfix lane — fix a standalone defect without the full SDLC (no story/arh-research/PRD/plan). Root-cause-first, surgical, regression-tested, evidence-gated. Bounces architectural changes back to /arh-intake.
