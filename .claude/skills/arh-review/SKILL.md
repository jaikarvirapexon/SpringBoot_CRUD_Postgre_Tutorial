...
These literals match the state schema `review` field, `/arh-implement` Step 4 verdict handling, and the code-review-agent hand-off. The exit code lets CI gate merges automatically.
...
Categories:     scope-creep=<n>  adr-violation=<n>
