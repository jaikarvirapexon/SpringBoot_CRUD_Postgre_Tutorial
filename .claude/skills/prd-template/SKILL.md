...
<!-- Authoritative list of screens this feature introduces or modifies. The
     ...
     invents screens. One row per screen. Omit this section entirely when
     `integrations.design == none` (backend / API / data feature). -->

| Screen | Primary purpose | States | Story ACs covered |
|---|---|---|---|
| <Screen name> | <one-line> | Populated / Loading / Empty / Error | <AC #1, AC #3> |
